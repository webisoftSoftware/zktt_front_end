	...
	return (
		<section className="relative">
			...
			<div className="max-w-6xl mx-auto px-4 sm:px-6">
				<div className="pt-32 pb-20 md:pt-40 md:pb-20">
					{/* Hero content */}
					<div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row ">
						...
						<div className="md:w-[640px]">
							...
							>
								...
								<div>
									...
									<div className="text-gray-500">Devs</div>
								</div>
								<svg
									className="fill-gray-300"
									width="14"
						...
						{/* Image */}
						<div
							className="max-w-sm mx-auto md:max-w-none md:absolute md:left-[40rem] md:ml-16 lg:ml-32 xl:ml-36 mt-12 md:-mt-12"
							data-aos="fade-left"
